...
<div class="container main-container">
    ...
    <h2 class="col-md-3">Giriş:</h2>

    <form:form action="${pageContext.request.contextPath}/authenticate" method="POST" class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mt-5">

        <div class="form-group">
            <c:if test="${param.error != null}">
                <p><span class="error">Yanlış giriş!</span></p>
            </c:if>
            <label for="inputEmail">Email</label>
            <input class="form-control" id="inputEmail" type="text" name="username" placeholder="Enter email">
        </div>
        <div class="form-group">
