...
<body>
    ...
    <div class="container main-container">
        ...
        <h2 class="col-md-3">Araç güncelleme:</h2>
        ...
        <form:form action="/admin/update/car" modelAttribute="car" method="PUT" class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mt-5">
            ...
            <div class="form-group">
                ...
                <form:input path="priceForOneDay" class="form-control" type="number" name="priceForOneDay" placeholder="Price for one day in TL" />
            </div>
            ...
            <input onclick="if (!(confirm('Aracı güncellemek istediğinizden emin misiniz ?'))) return false" class="btn btn-primary mt-3" type="submit" name="submit" value="Güncelle">
        </form:form>
